...
// console.log(`My favorite episode is ${('Episode Name', netflix.season1.seasonInfo.episodeInfo[2].episodeName)} on season ${('Episode Name', netflix.
// season1[])} `)
...
Object.keys(garden).forEach(g => {
    console.log(g)
    if (g == x){
        console.log('Yays, its', garden[x])
    } eles {
        console.log("Theres no water")
    }
})
